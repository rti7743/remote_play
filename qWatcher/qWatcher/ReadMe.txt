========================================================================
    Win32 アプリケーション: qWatcher プロジェクトの概要
========================================================================

この qWatcher アプリケーションは、AppWizard により作成されました。
...
qWatcher.ico
    ...
    ファイルです。
    このアイコンは、メイン リソース ファイル qWatcher.rc 
    にインクルードされます。

small.ico
    これは、アプリケーションのアイコンの小さいバージョン (16x16) を含むアイコン 
    ファイルです。 このアイコンは、メイン リソース ファイル qWatcher.rc 
    にインクルードされます。
