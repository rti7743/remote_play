...
namespace RemotePlay2
{
    class U
    {
        ...
        public static void SendWakeOnLan(string remoteIP)
        {
            ...
            // マジックパケットを送信
            udp.Send(sendBytes, sendBytes.Length, remoteIP, remotePort);
    ...
    string pszFileName, uint dwMode);
        ...
        #endregion
        public static void MakeShortcut(string src, string shortcut)
        {
        ...
        public static void WakeUpHost(string filename)
        {
